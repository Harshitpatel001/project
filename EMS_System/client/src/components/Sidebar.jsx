...
import { LogOutIcon, ChevronRightIcon, SettingsIcon, DollarSignIcon, FileTextIcon, CalendarIcon, LayoutGridIcon, UserIcon, MenuIcon, XIcon, Loader2 } from 'lucide-react'
...
const Sidebar = () => {
    ...
    const sidebarContent = (
        <>
                ...
                <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            tracking-wide'>Employee MS</p>
                            <p className='text-[11px] text-slate-500
                            font-medium'>Management System</p>
                        </div>
                    </div>
            ...
            {/* User profile card */}
            {userName && (
                <div className='mx-3 mt-4 mb-1 p-3 rounded-1g bg-white/3
                    ...
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='min-w-0'>
                            ...
                            <p className='text-[11px] text-slate-500
                            truncate'>{role === "ADMIN" ? "Administrator" : "Employee"}</p>
                        </div>
                    </div>
                </div>
            )}
            ...
            <div className='px-5 pt-5 pb-2'>
                <p className='text-[10px] font-semibold uppercase tracking-
                [0.12em] text-slate-500'>Navigation</p>
            </div>
            ...
            <div className='flex-1 px-3 space-y-0.5 overflow-y-auto'>
                {loading ? (
                    ...
                    return (
                        <Link key={item.name} to={item.href} className={`group flex items-center gap-3 px-3 py-2.5 rounded-md text-[13px] 
                ...
                shrink-0 ${isActive ? "text-indigo-300" :
                                    "text-slate-400 group-hover: text-slate-300"}`} />
                            <span className="flex-1">{item.name}</span>
                            {isActive && <ChevronRightIcon className="w-3.5
                h-3.5 text-indigo-500/50"/>}
                        </Link>
                    )
                })
                )}
            ...
            <div className="p-3 border-t border-white/6">
                ...
                font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8
    ...
    fixed top-4 left-4 z-50 p-2 bg-slate-900 text-white rounded-1g
    ...
    bg-linear-to-b from-slate-900 via-slate-900 to-slate-950 text-white shrink-0 border-r border-white/4'>
            ...
            {/* Sidebar mobile */}
            <aside className={`lg:hidden fixed inset-y-0 left-0 w-72 bg-linear-to-b 
                from-slate-900 via-slate-900 to-slate-950 text-white z-50 flex flex-col transform 
