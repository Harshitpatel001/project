        ...
        <form className='space-y-5' onSubmit={handleSubmit}>
          ...
          <div className='block text-sm font-medium text-slate-700 mb-2'>
            ...
            <div className='relative'>
              ...
              <button type='button' className="absolute right-3 top-1/2
              -translate-y-1/2 text-slate-400 hover:text-slate-600
              transition-colors" onClick={()=>setShowPassword(!showPassword)}>
          ...
          font-semibold hover:from-indigo-700
          hover:to-indigo-600
          disabled:opacity-50 transition-all
          duration-200 shadow-lg
          shadow-indigo-500/25 active:scale-[0.98]
