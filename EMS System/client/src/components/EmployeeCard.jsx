...
const EmployeeCard = ({ employee, onDelete, onEdit }) => {
    ...
    return (
        <div className='group relative card card-hover overflow-hidden'>
            ...
            w-full overflow-hidden bg-linear-to-br from-slate-100 to-slate-50'>
                <div className='w-full h-full flex items-center justify-center'>
                    {/* circle icons */}
                    <div className='w-20 h-20 rounded-full bg-linear-to-br
                    from-indigo-100 to-slate-100 flex items-center justify-center'>
            ...
            {!employee.isDeleted && (
                ...
                justify-center pb-6 gap-3'>
                    <button onClick={() => onEdit(employee)} className='p-2.5 bg-white/90 backdrop-blur-sm text-slate-700 hover:text-indigo-600 rounded-xl shadow-lg transition-all
                    hover:scale-105'>
            ...
            <div className='p-5'>
                <h3 className='text-slate-900'>{employee.firstName} {employee.
                    lastName}</h3>
