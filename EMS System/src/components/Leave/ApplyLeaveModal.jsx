...
text-slate-800'>Apply for Leave</h2>
                            <p className='text-sm text-slate-400 mt-0.5'>Submit
                                your leave request for approval</p>
                        </div>
...
font-medium text-slate-700 mb-2'>
                        ...
                        <div>
                            ...
                            <textarea name="reason" required rows={3}
                                className="resize-none" placeholder="Briefly describe
why you need this leave..." />
                        </div>
                        ...
                        <div className="flex gap-3 pt-2" >
                            ...
                            <button onClick={onClose} disabled={loading}
                                type='submit' className="btn-primary flex-1 flex
