    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">
            ...
            <div className="card p-5 sm:p-6">
                ...
                text-slate-700">
                    ...
                    <div>
                        ...
                        <input name="lastName" required defaultValue=
                    ...
                    <div>
                        ...
                        <input type="date" name="joinDate" required defaultValue={initialData?.joinDate ? new Date
                            (initialData.joinDate).toISOString().split("T")[0] : ""} />
                    </div>
                    <div className="sm:col-span-2">
                        <label className="block mb-2">Bio (Optional)</label> <textarea name="bio" defaultValue={initialData?.bio} rows={3} className="resize-none" placeholder="Brief description..." />
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    <div>
                        ...
                        <select name="department" defaultValue={initialData?.department || ""}>
                            <option value="">Select Department</option> {DEPARTMENTS.map(
                                (deptName) => (<option key={deptName} value={deptName}> {deptName} </option>
                                ))}
                        </select>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="deductions" min="0"
            ...
            <div className="card p-5 sm:p-6">
                ...
                border-b border-slate-100">Account Setup</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm
                text-slate-700">
                    <div className="sm:col-span-2">
                    ...
                    {isEditMode && (
                        <div>
                            <label className="block mb-2">Change Password
                                (Optional)</label>
                    ...
                    <div>
                        ...
                        <select name="role" defaultValue={initialData?.
                            user?.role || "EMPLOYEE"}>
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-2">
                ...
                flex items-center justify-center">
                    {loading && <Loader2Icon className="w-4 h-4 mr-2animate-spin"/>}
